...
tukuicheck:SetScript("OnEvent", function()
	if not (resolution == "2560x1440" or resolution == "1680x1050" or resolution == "1920x1080" or resolution == "1920x1200" or resolution == "1600x900" or resolution == "2048x1152" or resolution == "1776x1000" or resolution == "2560x1600" or resolution == "1600x1200") then
		print(resolution);
...
local function UIHelp()
	if (L=="ruRU") then
		...
		print("|cffFF0000>|r Средний клик на миникарте для открытия календаря.")
	...
	elseif(L=="frFR") then
		...
		print("|cffFF0000>|r Clic milieu sur la minicarte pour voir le calendrier.")
