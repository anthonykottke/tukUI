if not TukuiLootWindow == true then return end
...
local createSlot = function(id)
	...
	count:SetFont("Interface\\AddOns\\Tukui\\media\\Russel Square LT.ttf", 12, "OUTLINE")
	...
	name:SetFont("Interface\\AddOns\\Tukui\\media\\Russel Square LT.ttf", 13, "OUTLINE")
...
title:SetFont("Interface\\AddOns\\Tukui\\media\\Russel Square LT.ttf", 13, "OUTLINE")
