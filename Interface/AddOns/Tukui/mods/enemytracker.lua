...
if not IsAddOnLoaded("Afflicted3") then
	if arenatracker == true then
		...
		tCooldownTracker.Spells = TrackerIDs
		...
		function tCooldownTracker.CreateIcon()
			...
			tCooldownTracker.Icons[i].border:SetTexture("Interface\\Addons\\Tukui\\media\\border2.tga")
			tCooldownTracker.Icons[i].border:SetHeight(32.5)
			tCooldownTracker.Icons[i].border:SetWidth(32.5)
