...
if not TukuiBags == true then return end
...
function Stuffing:Layout(lb)
	...
	f:SetBackdropColor(unpack(TUKUI_BACKDROP_COLOR))
	f:SetBackdropBorderColor(unpack(TUKUI_BORDER_COLOR))
	...
	if bag_bars == 1 then
		...
		fb:SetBackdropColor(unpack(TUKUI_BACKDROP_COLOR))
		fb:SetBackdropBorderColor(unpack(TUKUI_BORDER_COLOR))
